...
namespace Assets.Scripts
{
    ...
    /// </summary>
    /// <remarks>The <see cref="RaceTimer_old"/> class tracks the elapsed time of a race and allows for manual
    ...
    public class RaceTimer_old : MonoBehaviour
    {
        ...
        public void StopRace()
        {
            ...
            UnityEngine.Debug.Log($"Race stopped. Total time: {raceTime} seconds");
        }
